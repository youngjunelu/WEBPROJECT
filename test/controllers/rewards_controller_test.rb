...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { cost: @reward.cost, is_bought: @reward.is_bought, reward_name: @reward.reward_name }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { cost: @reward.cost, is_bought: @reward.is_bought, reward_name: @reward.reward_name }
    assert_redirected_to reward_path(assigns(:reward))
  end
